...
public class MemberMenu {
	...
	public void doMemberMenu() throws MemberException, IOException{
	...
	private void menuMemberList() throws MemberException, IOException{
		memberList = member.listMember();         			//회원 리스트 출력하기
		((AbstractBase)member).displayData(memberList);
	}
	
	private void menuMemberView() throws MemberException, IOException{
		Scanner sc = new Scanner(System.in);
	...
	private void menuMemberReg() throws MemberException, IOException{
		Scanner sc = new Scanner(System.in);
	...
	private void menuMemberMod() throws MemberException, IOException{
	...
	private void menuMemberDel() throws MemberException, IOException{
		menuMemberList();
		Scanner sc = new Scanner(System.in);
