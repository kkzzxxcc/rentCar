...
import com.oracle.rent.ch19.car.CarException;
...
public class ResMenu {
	...
	public void doResMenu() throws ResException, CarException, IOException{
	...
	private void menuResList() throws ResException, IOException{
		resList = res.listResInfo();         			//예약 정보 리스트 출력하기
		((AbstractBase)res).displayData(resList);
	}
	
	private void menuResView() throws ResException, IOException{
		Scanner sc = new Scanner(System.in);
	...
	private void menuResReg() throws ResException, CarException, IOException{
	...
	private void menuResMod() throws ResException, IOException{
	...
	private void menuResDel() throws ResException, IOException{
		menuResList();
		Scanner sc = new Scanner(System.in);
